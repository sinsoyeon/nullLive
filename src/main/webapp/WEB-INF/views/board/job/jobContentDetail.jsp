...
<body>
	...
	<div class="outer">
		...
		<hr>
		<!-- 게시자 정보 영역 -->
		<div class="divTest col-lg-8" style="height: 56px">
			<div>게시자 정보</div>
			<button class="btn btn-info">상세정보</button>
		</div>
		<!-- 건당 금액 -->
		<div class="divTest col-lg-8" style="height: 40px">
			<div>건당금액</div>
			<label>10000원</label>
		</div>
		<!-- 버튼영역  -->
