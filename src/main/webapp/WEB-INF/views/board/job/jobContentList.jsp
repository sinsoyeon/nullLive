		...
		<div class="tableArea" align="center">
			...
			<c:if test="${ !empty loginUser }">
				<div class="btnArea">
					...
					<button onclick="location.href='jobContentInsertForm.jbo'" class="btn">글쓰기</button>
				</div>
			</c:if>
	        ...
	        <form onSubmit="pagingHandler" method="get" id='frmPaging'>
	            ...
	            <!-- 페이징 추가 쿼리스트링 -->
	            <!-- 내가 쓴 글 페이징 -->
	        	<input type='hidden' name='url' value='board/job/jobContentList'>
	        </form>
